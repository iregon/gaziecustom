...
class PreventivoCliente extends Template
{
    ...
    function pageFooter()
    {
        ...
        $this->Cell(186,6,'Esta oferta es válida por 2 días hábiles, después de este período, los precios y condiciones de venta pueden',0,1,'L');
        $this->Cell(186,6,'someterse a cambios que dependen de las condiciones del mercado.','B',1,'L');
    }
