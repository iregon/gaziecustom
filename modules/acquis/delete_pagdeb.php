...
<div align="center"><font class="FacetFormHeaderFont">Attenzione!!! Stai eliminando l'<?php echo $tipobro." n.".$form['numdoc']; ?> </font></div>
...
<tr>
<td class="FacetFieldCaptionTD">Numero di ID &nbsp;</td><td class="FacetDataTD"><?php echo $form["id_tes"]; ?>&nbsp;</td>
</tr>
<tr>
<td class="FacetFieldCaptionTD">Tipo documento &nbsp;</td><td class="FacetDataTD"><?php echo $tipobro; ?>&nbsp;</td>
</tr>
<tr>
<td class="FacetFieldCaptionTD">Numero Documento &nbsp;</td><td class="FacetDataTD"><?php echo $form["numdoc"]; ?>&nbsp;</td>
</tr>
<tr>
<td class="FacetFieldCaptionTD">Fornitore &nbsp;</td><td class="FacetDataTD"><?php echo $cliente["ragso1"]; ?>&nbsp;</td>
</tr>
<tr>
<td class="FacetFieldCaptionTD">Num. di righi &nbsp;</td><td class="FacetDataTD"><?php echo $numrig; ?>&nbsp;</td>
</tr>
<tr>
