...
/*
 ...
 --------------------------------------------------------------------------
    ...
    Fifth Floor Boston, MA 02110-1335 USA Stati Uniti. Torre
 --------------------------------------------------------------------------
*/
...
class FatturaAllegata extends Template
{
    ...
    function setTesDoc()
    {
        ...
        $this->tipdoc = 'Fattura n.'.$this->tesdoc['numfat'].' Adjunta a los recibos n.'.$this->tesdoc['numdoc'].' del '.$this->data;
    }
    ...
    function newPage() {
        ...
        $this->Cell(4);
        $this->Cell(20,5,'Descuento base','LTR',1,'C',1);
        $this->Cell(100);
        $this->Cell(62,5,$this->docVars->rs_agente['ragso1'],'LBR');
        $this->Cell(4);
        $this->Cell(20,5,gaz_format_number($this->sconto).'%','LBR',1,'C');
        $this->Ln(2);
        $this->Cell(23,6,'Codigo',1,0,'C',1);
        $this->Cell(75,6,'Descripcion',1,0,'C',1);
        $this->Cell(6, 6,'U.M.',1,0,'C',1);
        $this->Cell(14,6,'Cantidad',1,0,'C',1);
        $this->Cell(15,6,'Precio',1,0,'C',1);
        $this->Cell(7, 6,'% Desc.',1,0,'C',1);
        $this->Cell(18,6,'Importe',1,0,'C',1);
        $this->Cell(10,6,'%IVA',1,0,'C',1);
        $this->Cell(18,6,'Total',1,1,'C',1);
    }
