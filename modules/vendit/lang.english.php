...
$strScript = array("admin_client.php" =>
    ...
    array('title' => 'Menage tax receivable',
        ...
        'errors' => array(
              'datemi'=>'Incorrect emissione date',
              'clfoco'=>'It was not a customer selected',
              'pagame'=>'It was not a payment method selected',
              'rowdes'=>'In one row there isn\'t a description',
              'unimis'=>'In one row there isn\'t a unit of measure',
              'totzer'=>'The total of receivable can not be zero',
              'incaut'=>'Payment is not expected to be collected automatically while an anonymous customer',
              'codfis'=>'Incorrect fiscal code ',
              'ecrclo'=>'YOU DO NOT HAVE DONE THE DAILY ACCOUNTING/CLOSURE OF CASH REGISTER',
           'cashlimit'=>'The amount does not issue a sales document anonymously'
        ),
