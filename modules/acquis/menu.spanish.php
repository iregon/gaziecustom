...
$transl['acquis'] = array('name' => "Compras",
    'title' => "Administracion de Compras",
    'm2' => array(1 => array("Administracion de pedidos y de las estimaciones de los proveedores", "Estimacion y Pedido"),
        2 => array("Administracion de notas de entrega de los proveedores", "Notas de entrega"),
        3 => array("Administracion de Factura de Compras", "Factura de Compras"),
        4 => array("Reporte de cuentas pagables", "Cuentas pagables"),
    ...
    'm3' => array(1 => array("Solicitar una cotizacion al proveedor", "Solicitar cotizacion"),
        ...
        3 => array("Emitir Notas de Entrega para devorlver al proveedor", "Notas de Entrega al proveedor"),
        4 => array("Emisi&oacute;n de Notas de entrega para procesamiento", "Notas de entrega para procesamiento"),
        5 => array("Registro de Factura de Compra", "Ingresar Factura"),
        6 => array("Registro de nota de credito de compra", " Ingresar nota de credito"),
        7 => array("Contabilidad de facturas de compra", "Contabilidad de facturas"),
        8 => array("Inserte nuevo proveedor", "Nuevo proveedor"),
        9 => array("Reporte de Notas de Entrega de Compra", "Reporte de Notas de Entrega"),
